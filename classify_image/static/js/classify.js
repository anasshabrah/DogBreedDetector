                ...
                success: function(data) {
                  ...
                  if (data["success"] == true) {
                        ...
                        if(y[0] <= 90){
                          ...
                          if(counter < 3)
                               $('head').append('<style>.modal{height:' + 465+';}</style>')
                         else if(counter==3)
                                $('head').append('<style>.modal{height:' + 520+';}</style>')
                          else if(counter ==4)
                                 $('head').append('<style>.modal{height:' + 570+';}</style>')
                          else
                                $('head').append('<style>.modal{height:' + 620+';}</style>')
